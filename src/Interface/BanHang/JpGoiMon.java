...
public final class JpGoiMon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jpThongTinBan.setBackground(Color.decode("#dedcc8"));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Image11/cafe (1).png"))); // NOI18N

        lblgioden.setText(".....");

        lbltrangthai.setText("....");

        jPanel1.setBackground(Color.decode("#dedcc8"));

        btndatban.setBackground(new java.awt.Color(255, 255, 240));
        btndatban.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        btndatban.setText("Đặt chỗ");
        btndatban.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 212, 58), 3));
        ...
        btngoi.setBackground(new java.awt.Color(255, 255, 240));
        btngoi.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        btngoi.setText("Gọi món");
        btngoi.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 212, 58), 3));
        ...
        jpThongTinThanhToan.setBackground(Color.decode("#f58e8e"));
        ...
        btnthugon.setBackground(new java.awt.Color(255, 255, 240));
        btnthugon.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        btnthugon.setText("<<");
        btnthugon.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 212, 58), 3));
        ...
        jpThongTinBanLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpThongTinBanLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblTenBan, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(125, 125, 125))
        );
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/Image11/menu-pencil-emblem-600w-425933194.jpg"))); // NOI18N
    ...
    public void fillDsMon(int mahd){
        ...
        if(order != null){
            ...
            for(int i=0;i<order.size();i++){
                ...
                pn[i].setBackground(Color.decode("#f7f3df"));
          ...
          //      Icon ic = new ImageIcon("src/Icons/DeleteRed.png");
                JLabel lbl = new JLabel("X", null,JLabel.CENTER);
                lbl.setForeground(Color.decode("#000000"));
